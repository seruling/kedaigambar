...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
		...
		echo "<div class='col-md-7'>" . $row["caption"]. "</div>";
		$filepath = base64_encode("images/" . $row["filename"]);
		echo "<div class='col-md-2'>Download Now!<br/> <a href='download.php?type=jpg&file=$filepath'>JPG</a> | <a href='download.php?type=zip&file=$filepath'>ZIP</a></div>";
		echo " </div>";
		$rowcol = !$rowcol;
		$rowcount++;
    }
